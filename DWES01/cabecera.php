...
<head>
    <meta charset="utf-8">
    <title>DWES01 - Ubaldo Hidalgo</title>
    <link rel="stylesheet" href="./css/custom.css">
</head>
<body>
    <ul class="navbar">
        <li class="navbarChild"><a href="index.php">Formulario<br/>vacío</a></li>
        <li class="navbarChild"><a href="index.php?typeform=preload">Formulario precargado<br/>correcto y real</a></li>
